    ...
    <>
      ...
      <nav className={`nav${navScrolled ? ' scrolled' : ''}`} role="navigation" aria-label="Main navigation">
        <div className="nav-inner">
          <a href="#" className="nav-logo" aria-label="{'Cramer Law Firm'} home">
            {'Cramer Law Firm'}
          </a>
          ...
          <ul className={`nav-links${mobileMenuOpen ? ' mobile-open' : ''}`}>
            ...
            <li>
              <a
                href={'tel:12149981861'}
                className="nav-cta"
                aria-label="Call {'Cramer Law Firm'} at {'+1 214-998-1861'}"
      ...
      <section className="hero">
        <div className="hero-image-wrap">
          <img
            src={'https://images.unsplash.com/photo-1521791055366-0d553872952f?auto=format&fit=crop&w=1400&q=80'}
            alt=""
            loading="eager"
        ...
        <div className="hero-content">
          <div className="hero-badge">
            ...
            Trusted Legal Counsel in {'Dallas'}, {'TX'}
          </div>
          ...
          <p className="hero-subtitle">
            ...
            {'Cramer Law Firm'} provides aggressive, compassionate representation for clients across {'Dallas'} and {'TX'}.
          </p>
          ...
          <div className="hero-actions">
            <a
              ...
              aria-label="Call {'Cramer Law Firm'} for a free consultation"
              style={{ cursor: 'pointer' }}
            >
              <Icon name="phone" className="btn-icon" />
              Free Consultation
      ...
      <section className="trust-bar" aria-label="Credentials and trust indicators">
        <div className="trust-bar-inner">
          {[
            'Serving Dallas Families and Businesses for Over 20 Years',
            'Exposed to Over $50M in Recovered Settlements',
            'Top-Rated on Google by 200+ Dallas Clients',
            'Free Initial Consultations -- No Obligation, No Pressure',
          ].map((text, i) => (
      ...
      <section className="section services-section" id="services">
        ...
        <div className="services-grid">
          {([
            { title: 'Personal Injury', desc: 'Injured in a Dallas accident? Cramer Law Firm fights aggressively to recover maximum compensation so you can focus on healing, not paperwork.' },
            { title: 'Family Law', desc: 'Divorce, custody, and support matters handled with discretion and resolve. We protect what matters most to Dallas families navigating difficult transitions.' },
            { title: 'Criminal Defense', desc: 'Facing charges in Dallas County? Our defense attorneys know the local courts inside and out and build strategies designed to protect your future.' },
            { title: 'Business Litigation', desc: 'From contract disputes to partnership breakdowns, we represent Dallas businesses with the tenacity and precision that complex commercial cases demand.' },
            { title: 'Estate Planning', desc: 'Wills, trusts, and probate tailored to Texas law. We help Dallas families secure their legacy and avoid costly surprises down the road.' },
            { title: 'Real Estate Law', desc: 'Navigating Dallas\'s fast-moving real estate market requires sharp legal counsel. We handle closings, disputes, and title issues with efficiency and care.' },
      ...
      <section className="section about-section" id="about">
        <div className="about-inner">
          <div className="about-image-wrap" data-animate>
            <img
              src={'https://images.unsplash.com/photo-1589994965851-a8f479c573a9?auto=format&fit=crop&w=1400&q=80'}
              alt=""
              loading="lazy"
          ...
          <div className="about-content" data-animate data-delay="2">
            ...
            <h2>Why Choose {'Cramer Law Firm'}</h2>
            <p>{'Cramer Law Firm was built on a simple promise: every client in Dallas deserves a legal team that treats their case like it is the only one that matters. From our office in the heart of Dallas, we bring decades of courtroom experience and deep Texas legal knowledge to individuals and businesses across the Metroplex. When the stakes are high and the outcome matters, Cramer Law Firm is the name Dallas trusts.'}</p>
      ...
      <section className="testimonials-section" id="testimonials">
        <div className="section-header" data-animate>
          ...
          <p className="section-subtitle">
            Our clients&apos; outcomes speak for themselves. Here&apos;s what people throughout {'Dallas'} have to say about working with our legal team.
          </p>
        </div>
      ...
      <footer className="footer" role="contentinfo">
        <div className="footer-inner">
          <div className="footer-brand">
            <h3>{'Cramer Law Firm'}</h3>
            <p>
              Providing dedicated legal representation to individuals and families across {'Dallas'}, {'TX'}.
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.9rem' }}>
              ...
              <span>{'3839 McKinney Ave STE 155, Dallas, TX 75204, USA'}, {'Dallas'}, {'TX'}</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="footer-links">
              <li><a href="#services" style={{ cursor: 'pointer' }}>{'Personal Injury'}</a></li>
              <li><a href="#services" style={{ cursor: 'pointer' }}>{'Family Law'}</a></li>
              ...
              <li><a href="#services" style={{ cursor: 'pointer' }}>{'Estate Planning'}</a></li>
              <li><a href="#services" style={{ cursor: 'pointer' }}>{'Real Estate Law'}</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="footer-links">
              <li>
                <a href={'tel:12149981861'} style={{ cursor: 'pointer' }}>
                  {'+1 214-998-1861'}
                </a>
              </li>
              <li>{'3839 McKinney Ave STE 155, Dallas, TX 75204, USA'}</li>
              <li>{'Dallas'}, {'TX'}</li>
            </ul>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <span>&copy; {new Date().getFullYear()} {'Cramer Law Firm'}. All rights reserved.</span>
          <span>Serving {'Dallas'}, {'TX'} and surrounding areas</span>
        </div>
      </footer>
    </>
  )
