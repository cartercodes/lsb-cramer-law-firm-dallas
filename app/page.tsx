    ...
    <>
      ...
      <section className="trust-bar" aria-label="Credentials and trust indicators">
        <div className="trust-bar-inner">
          {[
            'Serving Dallas Families & Businesses for Over 20 Years',
            'Exposed to Over $50M in Settlements & Verdicts',
            'Top-Rated on Google by 300+ Dallas Clients',
      ...
      <section className="section services-section" id="services">
        ...
        <div className="services-grid">
          {([
            { title: 'Personal Injury Claims', desc: 'Injured in a Dallas accident? Cramer Law Firm fights aggressively to secure the compensation you deserve — from I-35 collisions to workplace injuries across North Texas.' },
            { title: 'Family Law & Divorce', desc: 'Navigating divorce or custody disputes in Dallas County requires a firm that understands local family courts inside and out. We protect what matters most to you.' },
            { title: 'Criminal Defense', desc: 'Facing charges in Dallas? From misdemeanors to serious felonies, Cramer Law Firm delivers the relentless defense you need to protect your future and your freedom.' },
            { title: 'Business Litigation', desc: 'Dallas is a city built on business. When commercial disputes threaten your livelihood, we bring sharp legal strategy to protect your interests and your bottom line.' },
            { title: 'Estate Planning & Probate', desc: 'Secure your family\'s future with wills, trusts, and probate guidance tailored to Texas law. We help Dallas families plan with clarity and confidence.' },
            { title: 'Real Estate Law', desc: 'From commercial developments in Uptown to residential closings across DFW, we handle every legal detail so your real estate transactions close smoothly.' },
      ...
      <section className="section about-section" id="about">
        <div className="about-inner">
          ...
          <div className="about-content" data-animate data-delay="2">
            ...
            <p>{'Cramer Law Firm has been a trusted legal presence in Dallas for over two decades, representing individuals and businesses across North Texas with the kind of personal attention that big firms overlook. We built our reputation on straightforward counsel, aggressive advocacy, and deep roots in the Dallas community. When the stakes are high, Dallas turns to Cramer.'}</p>
